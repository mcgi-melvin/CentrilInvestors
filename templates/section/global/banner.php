<section id="global_banner" class="relative overlay bg-cover bg-center bg-no-repeat flex items-center h-[700px] px-[30px]" style="background-image: url(<?= get_field( 'banner_background_image' ) ?>)">

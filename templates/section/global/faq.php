...
<section id="global_faq" class="py-[100px]">
            ...
            <div class="faq-items flex flex-col gap-[20px]">
                <?php foreach ( $items as $i => $item ): ?>
                    <div class="faq-item item-<?= $i ?>">
                        <a href="javascript:void(0)" class="item-question bg-secondary flex items-center justify-between p-[30px]" onclick="toggleFaq(<?= $i ?>)">
                            <h4 class="text-[25px] font-roboto font-semibold text-white"><?= $item['question'] ?></h4>
                            <div>
                        ...
                        <div class="item-answer text-[20px] p-[30px] bg-gray-secondary hidden">
                            <?= $item['answer'] ?>
                        </div>
                    </div>
                <?php endforeach; ?>

...
<section id="about_values" class="overlay overlay-dark bg-cover bg-center bg-fixed bg-no-repeat py-[100px]" style="background-image: url(<?= get_field( 'values_background_image' ) ?>)">
    <div class="container max-w-[1500px] w-full">
        <div class="flex flex-col gap-[80px]">
            ...
            <div class="items grid grid-cols-3 flex-wrap gap-[15px]">
                <?php foreach ( $items as $item ): ?>
                    <div class="item bg-white rounded p-[50px]">
                        <div class="flex flex-col gap-[20px]">
                            <h4 class="h4"><?= $item['heading'] ?></h4>
                            <div class="description text-[25px]">
                                <?= $item['description'] ?>
                            </div>
                        </div>
                    </div>
